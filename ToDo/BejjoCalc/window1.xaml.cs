...
namespace BejjoCalc
{
    ...
    public partial class Window1 : Window
    {
        ...
        {
            Window parent = (Window)MyPanel.Parent;
            MessageBox.Show(parent, parent.Title + " - By Aldhiya Rozak ", parent.Title,MessageBoxButton.OK, MessageBoxImage.Information);
        }
        void OnMenuExit(object sender, RoutedEventArgs e)
        {
            MessageBox.Show("Terima Kasih Sudah Menggunakan Program Bejjo");
            this.Close();
        }
        void OnMenuCopy(object sender, RoutedEventArgs e)
        {
            Clipboard.SetText(PaperBox.Text);
            MessageBox.Show("Berhasil Di Copy");
        }
        void OnMenuMerah(object sender, RoutedEventArgs e)
        {
            MessageBox.Show("Merah");   
        }
        void OnMenuKuning(object sender, RoutedEventArgs e)
        {
            MessageBox.Show("Merah");
        }
        void OnMenuHijau(object sender, RoutedEventArgs e)
        {
            MessageBox.Show("asd");
        }
